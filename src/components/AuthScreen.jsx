    ...
    <div className="max-w-md mx-auto min-h-screen flex items-center justify-center px-5">
      <div className="text-center w-full">
        ...
        <button
          ...
          className="w-full max-w-xs mx-auto flex items-center justify-center gap-3 px-6 py-3 bg-white border border-gray-200 rounded-2xl text-sm font-bold hover:border-brand transition-colors"
        >
